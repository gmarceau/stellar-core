...
TEST_CASE("TCPPeer can communicate", "[overlay]")
{
    ...
    SecretKey v10 = Simulation::createKey(10);
    SecretKey v11 = Simulation::createKey(11);

    auto n0 = s->getNode(s->addNode(v10, SCPQuorumSet(), s->getClock()));
    auto n1 = s->getNode(s->addNode(v11, SCPQuorumSet(), s->getClock()));
